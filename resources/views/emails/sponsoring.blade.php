...
<head>
    ...
    <title>Nieuw sponsoraanvraag</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 28px;">
                            <p style="margin: 0 0 20px; font-size: 14px; color: #64748b;">
                                Er is een nieuwe aanvraag voor sponsoring binnengekomen via de website.
                            </p>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid #e2e8f0; border-radius: 8px; overflow: hidden;">
                                <tr>
                                    <td style="padding: 6px 12px; background-color: #f8fafc; font-size: 12px; font-weight: 600; color: #64748b; border-bottom: 1px solid #e2e8f0; width: 140px;">
                                        Naam
                                    </td>
                            ...
                            @if (!empty($data['message']))
                                <p style="margin: 20px 0 0; font-size: 12px; font-weight: 600; color: #64748b;">Bericht</p>
